...
public class BME280Service {
    ...
    /*
     @author https://github.com/ControlEverythingCommunity
     */
    private Double[] readMeasurements() throws I2CFactory.UnsupportedBusNumberException, IOException {

        I2CDevice device = getI2CDevice();
        ...
        return new Double[] {pressure, humidity, cTemp};
    }

    private I2CDevice getI2CDevice() throws I2CFactory.UnsupportedBusNumberException, IOException {
        // Create I2C bus
        I2CBus bus = I2CFactory.getInstance(I2CBus.BUS_1);
        // Get I2C device, BME280 I2C address is 0x76(108)
        return bus.getDevice(0x76);
    }
}
